...
class UserContactRegisterForm extends RegisterForm {
  ...
  /**
   * UserContactRegisterForm constructor.
   *
...
//  }
  ...
  /**
   * Constructs a new UserContactRegisterForm object.
   */
  public function __constructHI(
    EntityManager $entity_manager
  ) {
    $this->entityManager = $entity_manager;
  }

  public static function createHI(ContainerInterface $container) {
    return new static(
  ...
  public function contactForm(&$form, FormStateInterface &$form_state) {
    ...
    if ($config->get('connect_users')) {
      ...
      if (array_key_exists($contact_type, $types)) {
        ...
        $embed_key = 'account';
        $this->embedContactForm($form, $form_state, $contact_object, $config->get('registration_form'));
